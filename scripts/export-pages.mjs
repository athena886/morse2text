...
const routes = ["/", "/morse-code-alphabet", "/learn-morse-code"];
...
await copyFile(new URL("../public/404.html",import.meta.url),new URL("../dist/client/404.html",import.meta.url));
console.log(`Static export ready: ${routes.length} HTML pages + branded 404`);
